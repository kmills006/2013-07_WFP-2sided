    			  ...
    			  <div class="new-deck-info">
    			  	<h3>About Your New Flash Card Set</h3>
	    			  	...
	    			  	<? echo Form::open('deck/save'); ?>
							...
							<? echo Html::anchor('#', Asset::img('icons/add_card.png', array('alt' => 'Add another term and definition'))." Add another term by either clicking here or pressing TAB on the last input box.", array('class' => 'add-another-term'));
