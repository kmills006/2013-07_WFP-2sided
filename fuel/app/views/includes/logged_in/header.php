...
<!--
	    			<a class="globe-nav user-dd" href="#"><? echo Asset::img('profile_placeholders/kmills006_placeholder.png'); ?>kmills006
		    			...
		    			<ul class="dd-menu">
		    				<li><? echo Html::anchor('profile', 'View Profile'); ?></li>
		    				<li><? echo Html::anchor('dashboard', 'Dashboard'); ?></li>
		    				<li><? echo Html::anchor('settings', 'Settings'); ?></li>
		    				<li><? echo Html::anchor('logout', 'Logout'); ?></li>
		    			</ul>
