...
$.fn.flip = function(settings){
    return this.each( function() {
        ...
        $clone= $this.css("visibility","hidden")
            ...
            .appendTo("body")
            .html("")
            .css({visibility:"visible",position:"absolute",left:flipObj.left,top:flipObj.top,margin:0,zIndex:9999,"-webkit-box-shadow":"0px 0px 0px #ff0000","-moz-box-shadow":"0px 0px 0px #ff0000"});
